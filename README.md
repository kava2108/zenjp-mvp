...
日本株市場には、米国の WallStreetZen のような総合スコアリングサービスが存在しません。  
ZenJP は、このギャップを埋めるために、日本株に特化した独自のスコアリングシステムを提供することを目的としています。

## Zen MVP の目的

**2 週間で最小限の機能を実装し、以下を検証する：**

1. **スコアリングロジックの妥当性**
   - 計算したスコアが株価パフォーマンスと相関するか
   - 投資家にとって有用な指標となるか
